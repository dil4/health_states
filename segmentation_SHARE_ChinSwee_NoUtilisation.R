    ...
    ifelse(
      ...
      ifelse(
        ...
        ifelse(
          ...
          ifelse(
            ((dat_SHARE_ChinSwee$g==0&dat_SHARE_ChinSwee$e==1&dat_SHARE_ChinSwee$d==0)&(dat_SHARE_ChinSwee$a==1|dat_SHARE_ChinSwee$b==1|dat_SHARE_ChinSwee$c==1))|((dat_SHARE_ChinSwee$g==0&dat_SHARE_ChinSwee$d==1)&(dat_SHARE_ChinSwee$a==1|dat_SHARE_ChinSwee$b==1|dat_SHARE_ChinSwee$c==1))|((dat_SHARE_ChinSwee$g==0)&(dat_SHARE_ChinSwee$a==0&dat_SHARE_ChinSwee$b==0&dat_SHARE_ChinSwee$c==0)),
            "Chronic Stable and Long Course of Decline",
            "Lost"
